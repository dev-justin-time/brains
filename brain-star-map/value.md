...
| Front doors | Web console **https://ui-c7w.pages.dev**, public GitHub repo, 21 paid agents (17 @ $0.02/task, `lit_review` + `grant_writer` @ $0.10/task, 2 pipe @ $0.02/min) + 1 free (`star_map_demo`) (85/15 split) |
